...
def preprocess_user_input(user_input):
    ...
    stemmer = stemmer()
    stemmed_words = stemmer.get_stem_words(user_tokens, ignore_words)

    # Remove duplicacy and sort the user_input
    unique_words = sorted(set(stemmed_words))

    # Input data encoding : Create BOW for user_input
    for w in words:
     bag_of_words.append(1) if w in unique_words else bag_of_words.append(0)
